...
data class PictureInPictureStateEvent (
...
) : PlatformVideoEvent()
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as PictureInPictureStateEvent
    return MessagesPigeonUtils.deepEquals(this.isInPictureInPictureMode, other.isInPictureInPictureMode)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + MessagesPigeonUtils.deepHash(this.isInPictureInPictureMode)
    return result
  }
}
...
data class PipAction (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as PipAction
    return MessagesPigeonUtils.deepEquals(this.type, other.type) && MessagesPigeonUtils.deepEquals(this.label, other.label)
  }
...
data class CreationOptions (
   ...
   */
  val hlsManifestOverride: String? = null
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): CreationOptions {
      ...
      val hlsManifestOverride = pigeonVar_list[5] as String?
      return CreationOptions(uri, formatHint, httpHeaders, userAgent, backgroundPlayback, hlsManifestOverride)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun hashCode(): Int {
    ...
    result = 31 * result + MessagesPigeonUtils.deepHash(this.backgroundPlayback)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.hlsManifestOverride)
    return result
  }
}
...
data class NotificationMetadataMessage (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as NotificationMetadataMessage
    return MessagesPigeonUtils.deepEquals(this.id, other.id) && MessagesPigeonUtils.deepEquals(this.title, other.title) && MessagesPigeonUtils.deepEquals(this.album, other.album) && MessagesPigeonUtils.deepEquals(this.artist, other.artist) && MessagesPigeonUtils.deepEquals(this.durationMs, other.durationMs) && MessagesPigeonUtils.deepEquals(this.artUri, other.artUri)
  }
  ...
  override fun hashCode(): Int {
    ...
    result = 31 * result + MessagesPigeonUtils.deepHash(this.artUri)
    return result
  }
}
...
data class BackgroundPlaybackMessage (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as BackgroundPlaybackMessage
    return MessagesPigeonUtils.deepEquals(this.enableBackground, other.enableBackground) && MessagesPigeonUtils.deepEquals(this.notificationMetadata, other.notificationMetadata)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + MessagesPigeonUtils.deepHash(this.enableBackground)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.notificationMetadata)
    return result
  }
}
