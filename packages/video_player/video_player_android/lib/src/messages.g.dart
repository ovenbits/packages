...
class PictureInPictureStateEvent extends PlatformVideoEvent {
  ...
  static PictureInPictureStateEvent decode(Object result) {
    result as List<Object?>;
    return PictureInPictureStateEvent(isInPictureInPictureMode: result[0]! as bool);
  }
...
class PipAction {
  ...
  static PipAction decode(Object result) {
    result as List<Object?>;
    return PipAction(type: result[0]! as PipActionType, label: result[1]! as String);
  }
...
class CreationOptions {
  ...
  List<Object?> _toList() {
    return <Object?>[uri, formatHint, httpHeaders, userAgent, backgroundPlayback];
  }
