...
void main() {
  ...
  provideDummy<BackgroundPlaybackMessage>(BackgroundPlaybackMessage(enableBackground: false));
  provideDummy<NotificationMetadataMessage>(NotificationMetadataMessage(id: 'dummy'));
  ...
  group('AVFoundationVideoPlayer', () {
    ...
    test('createWithOptions passes allowExternalPlayback true by default', () async {
      final (AVFoundationVideoPlayer player, MockAVFoundationVideoPlayerApi api, _) =
          setUpMockPlayer(playerId: 1, textureId: 101);
      const newPlayerId = 2;
      when(
    ...
    test('createWithOptions passes allowExternalPlayback false when set', () async {
      final (AVFoundationVideoPlayer player, MockAVFoundationVideoPlayerApi api, _) =
          setUpMockPlayer(playerId: 1, textureId: 101);
      const newPlayerId = 2;
      when(
