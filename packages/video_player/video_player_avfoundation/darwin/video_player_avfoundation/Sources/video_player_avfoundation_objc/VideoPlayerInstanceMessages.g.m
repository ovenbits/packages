...
- (BOOL)isEqual:(id)object {
  ...
  return FLTPigeonDeepEquals(self.id, other.id) && FLTPigeonDeepEquals(self.title, other.title) &&
         FLTPigeonDeepEquals(self.album, other.album) &&
         FLTPigeonDeepEquals(self.artist, other.artist) &&
         FLTPigeonDeepEquals(self.durationMs, other.durationMs) &&
         FLTPigeonDeepEquals(self.artUri, other.artUri);
}
...
- (BOOL)isEqual:(id)object {
  ...
  return self.enableBackground == other.enableBackground &&
         FLTPigeonDeepEquals(self.notificationMetadata, other.notificationMetadata);
}
...
void SetUpFVPVideoPlayerInstanceApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger,
  ...
  }
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.flutter.pigeon.video_player_avfoundation."
                                                   @"VideoPlayerInstanceApi.startPictureInPicture",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FVPGetVideoPlayerInstanceMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(startPictureInPicture:)],
                @"FVPVideoPlayerInstanceApi api (%@) doesn't respond to "
  ...
  }
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   @"dev.flutter.pigeon.video_player_avfoundation."
                                                   @"VideoPlayerInstanceApi.stopPictureInPicture",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FVPGetVideoPlayerInstanceMessagesCodec()];
    if (api) {
      NSCAssert(
          [api respondsToSelector:@selector(stopPictureInPicture:)],
          @"FVPVideoPlayerInstanceApi api (%@) doesn't respond to @selector(stopPictureInPicture:)",
          api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
  ...
  }
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString
                            stringWithFormat:@"%@%@",
                                             @"dev.flutter.pigeon.video_player_avfoundation."
                                             @"VideoPlayerInstanceApi.setAutoPictureInPicture",
                                             messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:FVPGetVideoPlayerInstanceMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setAutoPictureInPicture:error:)],
                @"FVPVideoPlayerInstanceApi api (%@) doesn't respond to "
                @"@selector(setAutoPictureInPicture:error:)",
                api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
