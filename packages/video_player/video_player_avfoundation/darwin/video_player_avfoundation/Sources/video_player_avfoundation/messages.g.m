...
+ (instancetype)makeWithUri:(NSString *)uri
    ...
    hlsManifestOverride:(nullable NSString *)hlsManifestOverride {
  FVPCreationOptions* pigeonResult = [[FVPCreationOptions alloc] init];
  pigeonResult.uri = uri;
  pigeonResult.httpHeaders = httpHeaders;
  pigeonResult.allowExternalPlayback = allowExternalPlayback;
  pigeonResult.backgroundPlayback = backgroundPlayback;
  pigeonResult.hlsManifestOverride = hlsManifestOverride;
  return pigeonResult;
}
+ (FVPCreationOptions *)fromList:(NSArray<id> *)list {
  FVPCreationOptions *pigeonResult = [[FVPCreationOptions alloc] init];
  ...
  pigeonResult.allowExternalPlayback = [GetNullableObjectAtIndex(list, 2) boolValue];
  pigeonResult.backgroundPlayback = GetNullableObjectAtIndex(list, 3);
  pigeonResult.hlsManifestOverride = GetNullableObjectAtIndex(list, 4);
  return pigeonResult;
}
+ (nullable FVPCreationOptions *)nullableFromList:(NSArray<id> *)list {
...
- (NSArray<id> *)toList {
  return @[
    ...
    @(self.allowExternalPlayback),
    self.backgroundPlayback ?: [NSNull null],
    self.hlsManifestOverride ?: [NSNull null],
  ];
}
- (BOOL)isEqual:(id)object {
  if (self == object) {
  ...
  return FLTPigeonDeepEquals(self.uri, other.uri) && FLTPigeonDeepEquals(self.httpHeaders, other.httpHeaders) && self.allowExternalPlayback == other.allowExternalPlayback && FLTPigeonDeepEquals(self.backgroundPlayback, other.backgroundPlayback) && FLTPigeonDeepEquals(self.hlsManifestOverride, other.hlsManifestOverride);
}
...
- (NSUInteger)hash {
  ...
  result = result * 31 + @(self.allowExternalPlayback).hash;
  result = result * 31 + FLTPigeonDeepHash(self.backgroundPlayback);
  result = result * 31 + FLTPigeonDeepHash(self.hlsManifestOverride);
  return result;
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  FVPNotificationMetadataMessage *other = (FVPNotificationMetadataMessage *)object;
  return FLTPigeonDeepEquals(self.id, other.id) && FLTPigeonDeepEquals(self.title, other.title) && FLTPigeonDeepEquals(self.album, other.album) && FLTPigeonDeepEquals(self.artist, other.artist) && FLTPigeonDeepEquals(self.durationMs, other.durationMs) && FLTPigeonDeepEquals(self.artUri, other.artUri);
}
...
- (BOOL)isEqual:(id)object {
  ...
  FVPBackgroundPlaybackMessage *other = (FVPBackgroundPlaybackMessage *)object;
  return self.enableBackground == other.enableBackground && FLTPigeonDeepEquals(self.notificationMetadata, other.notificationMetadata);
}

- (NSUInteger)hash {
  NSUInteger result = [self class].hash;
  result = result * 31 + @(self.enableBackground).hash;
  result = result * 31 + FLTPigeonDeepHash(self.notificationMetadata);
  return result;
}
@end
